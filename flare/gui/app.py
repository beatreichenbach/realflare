...
from flare.gui.lensmodeleditor import LensModelDialog
from flare.update import UpdateDialog
from flare.api.data import Project, RenderElement, Flare, Render
from flare.api.engine import Engine
from flare.gui.viewer import ElementViewer
from flare.gui.settings import Settings
from flare.gui.flareeditor import FlareEditor
from flare.gui.rendereditor import RenderEditor

from flare.gui.logger import Logger
from flare.gui.presetbrowser import PresetBrowser
...
class MainWindow(DockWindow):
    ...
    def help_about(self) -> None:
        ...
        # icon
        icon_path = files('flare').joinpath('resources').joinpath('icon.png')
...
def exec_():
    ...
    splash_path = files('flare').joinpath('assets').joinpath('splash.png')
